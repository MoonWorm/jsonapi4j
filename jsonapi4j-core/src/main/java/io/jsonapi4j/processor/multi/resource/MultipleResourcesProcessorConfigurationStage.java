...
import io.jsonapi4j.processor.single.resource.SingleResourceJsonApiConfigurationStage;
...
public class MultipleResourcesProcessorConfigurationStage<REQUEST> {
     ...
     *
     * @param dataSupplier      data supplier function, returns {@link io.jsonapi4j.processor.CursorPageableResponse}, accepts parameter of type REQUEST
