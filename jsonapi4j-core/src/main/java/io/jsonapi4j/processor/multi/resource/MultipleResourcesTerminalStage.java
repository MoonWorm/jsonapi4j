...
import io.jsonapi4j.processor.RelationshipsSupplier;
import io.jsonapi4j.processor.ResourceProcessorContext;
import io.jsonapi4j.processor.ResourceSupplier;
import io.jsonapi4j.processor.ac.InboundAccessControlRequerementsEvaluator;
import io.jsonapi4j.processor.ac.OutboundAccessControlRequirementsEvaluatorForResource;
import io.jsonapi4j.processor.ac.OutboundAccessControlRequirementsEvaluatorForResource.ResourceAnonymizationResult;
import io.jsonapi4j.processor.multi.MultipleDataItemsSupplier;
import io.jsonapi4j.processor.util.CustomCollectors;
...
public class MultipleResourcesTerminalStage<REQUEST, DATA_SOURCE_DTO, ATTRIBUTES> {
     ...
     *                              - {@link io.jsonapi4j.model.document.data.ToManyRelationshipsDoc},
     *                              and all the resolved to-one relationships
     *                              - {@link io.jsonapi4j.model.document.data.ToOneRelationshipDoc}
