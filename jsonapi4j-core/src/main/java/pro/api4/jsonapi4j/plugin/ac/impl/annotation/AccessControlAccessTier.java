package pro.api4.jsonapi4j.plugin.ac.impl.annotation;
...
public @interface AccessControlAccessTier {
     ...
     * <ol>
     *     <li>{@link pro.api4.jsonapi4j.plugin.ac.impl.tier.TierRootAdmin#ROOT_ADMIN_ACCESS_TIER}</li>
     *     <li>{@link pro.api4.jsonapi4j.plugin.ac.impl.tier.TierAdmin#ADMIN_ACCESS_TIER}</li>
     *     <li>{@link pro.api4.jsonapi4j.plugin.ac.impl.tier.TierPartner#PARTNER_ACCESS_TIER}</li>
     *     <li>{@link pro.api4.jsonapi4j.plugin.ac.impl.tier.TierPublic#PUBLIC_TIER}</li>
     *     <li>{@link pro.api4.jsonapi4j.plugin.ac.impl.tier.TierNoAccess#NO_ACCESS_TIER}</li>
     * </ol>
     *
