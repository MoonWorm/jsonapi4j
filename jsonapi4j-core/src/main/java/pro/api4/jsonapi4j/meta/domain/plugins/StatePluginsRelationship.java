...
@JsonApiRelationship(relationshipName = PluginsResource.PLUGINS, parentResource = StateResource.class)
public class StatePluginsRelationship implements ToManyRelationship<Ref> {
