...
@JsonApiRelationship(relationshipName = ResourcesResource.RESOURCES, parentResource = StateResource.class)
public class StateResourcesRelationship implements ToManyRelationship<Ref> {
