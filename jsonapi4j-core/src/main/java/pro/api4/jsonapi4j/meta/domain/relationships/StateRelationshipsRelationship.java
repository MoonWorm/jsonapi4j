...
@JsonApiRelationship(relationshipName = RelationshipsResource.RELATIONSHIPS, parentResource = StateResource.class)
public class StateRelationshipsRelationship implements ToManyRelationship<Ref> {
