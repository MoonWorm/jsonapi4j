...
import pro.api4.jsonapi4j.processor.ResourceJsonApiConfigurationStage;
...
@Setter
@Getter
public class SingleResourceJsonApiConfigurationStage<REQUEST, DATA_SOURCE_DTO> extends ResourceJsonApiConfigurationStage<REQUEST, DATA_SOURCE_DTO> {
    ...
    public SingleResourceJsonApiConfigurationStage(REQUEST request,
    ...
    /**
     * Specifies the mapper that converts DATA_SOURCE_DTO object into the JSON:API Attributes object. Moves processor
     * to the final configuration stage - terminal operation.
     *
     * @param attributesResolver mapping function, returns object of {@link ATTRIBUTES} type, accepts parameter of type DATA_SOURCE_DTO
     * @param <ATTRIBUTES>       type, represents Attributes section of the JSON:API Resource
     * @return the final configuration state - {@link SingleResourceTerminalStage}
     */
    public <ATTRIBUTES> SingleResourceAttributesAwareJsonApiConfigurationStage<REQUEST, DATA_SOURCE_DTO, ATTRIBUTES> attributesResolver(
            AttributesResolver<DATA_SOURCE_DTO, ATTRIBUTES> attributesResolver
    ) {
        return new SingleResourceAttributesAwareJsonApiConfigurationStage<>(this, attributesResolver);
    }
     ...
     */
    public SingleResourceJsonApiConfigurationStage<REQUEST, DATA_SOURCE_DTO> topLevelLinksResolver(
     ...
     * @return self link to the terminal operation allowing to apply other configurations
     */
    public SingleResourceJsonApiConfigurationStage<REQUEST, DATA_SOURCE_DTO> topLevelMetaResolver(
     ...
     * @return self link to the terminal operation allowing to apply other configurations
     */
    public SingleResourceJsonApiConfigurationStage<REQUEST, DATA_SOURCE_DTO> defaultRelationships(
     ...
     */
    public SingleResourceJsonApiConfigurationStage<REQUEST, DATA_SOURCE_DTO> toManyRelationshipResolver(
    ...
    public SingleResourceJsonApiConfigurationStage<REQUEST, DATA_SOURCE_DTO> toManyRelationshipResolvers(
     ...
     * @throws IllegalStateException if the target relationship wasn't declared as 'default' relationship
     */
    public SingleResourceJsonApiConfigurationStage<REQUEST, DATA_SOURCE_DTO> toOneRelationshipResolver(
            RelationshipName relationshipName,
    ...
    public SingleResourceJsonApiConfigurationStage<REQUEST, DATA_SOURCE_DTO> toOneRelationshipResolvers(
     ...
     * @throws IllegalStateException if the target relationship wasn't declared as 'default' relationship
     */
    public SingleResourceJsonApiConfigurationStage<REQUEST, DATA_SOURCE_DTO> batchToManyRelationshipResolver(
            RelationshipName relationshipName,
    ...
    public SingleResourceJsonApiConfigurationStage<REQUEST, DATA_SOURCE_DTO> batchToManyRelationshipResolvers(
     ...
     * @throws IllegalStateException if the target relationship wasn't declared as 'default' relationship
     */
    public SingleResourceJsonApiConfigurationStage<REQUEST, DATA_SOURCE_DTO> batchToOneRelationshipResolver(
            RelationshipName relationshipName,
    ...
    public SingleResourceJsonApiConfigurationStage<REQUEST, DATA_SOURCE_DTO> batchToOneRelationshipResolvers(
     ...
     * @return self link to the terminal operation allowing to apply other configurations
     */
    public SingleResourceJsonApiConfigurationStage<REQUEST, DATA_SOURCE_DTO> resourceLinksResolver(
     ...
     * @return self link to the terminal operation allowing to apply other configurations
     */
    public SingleResourceJsonApiConfigurationStage<REQUEST, DATA_SOURCE_DTO> resourceMetaResolver(
     ...
     * @return self ref
     */
    public SingleResourceTerminalStage<REQUEST, DATA_SOURCE_DTO, ?> resourceTypeAndIdResolver(
        ...
        return new SingleResourceTerminalStage<>(
                ...
                dataSupplier,
                processorContext,
                SingleResourceJsonApiContext.<REQUEST, DATA_SOURCE_DTO, Object>builder()
