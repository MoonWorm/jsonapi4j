 ...
 */
public interface BatchReadToManyRelationshipOperation<RESOURCE_DTO, RELATIONSHIP_DTO>
        extends ReadToManyRelationshipOperation<RESOURCE_DTO, RELATIONSHIP_DTO> {
