...
public interface PayloadAwareRequest {
    ...
    default SingleResourceDoc<ResourceObject<LinkedHashMap, LinkedHashMap<String, RelationshipObject>>> getSingleResourceDocPayload() {
        return getSingleResourceDocPayload(LinkedHashMap.class);
    }
     ...
     */
    <A> SingleResourceDoc<ResourceObject<A, LinkedHashMap<String, RelationshipObject>>> getSingleResourceDocPayload(Class<A> attType);
