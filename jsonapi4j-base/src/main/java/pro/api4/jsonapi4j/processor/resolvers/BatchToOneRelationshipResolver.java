...
/**
 * Functional interface that resolves to-one relationship data for multiple resources in one call.
 * <p>
...
public interface BatchToOneRelationshipResolver<REQUEST, DATA_SOURCE_DTO> {
    ...
    /**
     * Resolves the to-one relationship for all resources in a single batched call.
     * <p>
     * Prefer this over {@link ToOneRelationshipResolver} when bulk-fetching relationship
     ...
     * @return a map from each resource DTO to its {@link ToOneRelationshipObject};
