...
/**
 * Implement this interface to let jsonapi4j framework know how to add one or many linkage objects
 * to this to-many relationship of the given resource.
 * <p>
 ...
 * Don't bring these checks to the {@link #add(JsonApiRequest)}. If some error is detected, thrown exception will be
...
public interface AddToManyRelationshipOperation extends RelationshipOperation {
    ...
    /**
     * Adds one or many linkage objects to this to-many relationship.
     *
