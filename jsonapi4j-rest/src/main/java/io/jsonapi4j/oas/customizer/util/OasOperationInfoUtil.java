...
import static io.jsonapi4j.http.HttpStatusCodes.SC_400_BAD_REQUEST;
import static io.jsonapi4j.http.HttpStatusCodes.SC_404_RESOURCE_NOT_FOUND;
import static io.jsonapi4j.http.HttpStatusCodes.SC_405_METHOD_NOT_SUPPORTED;
import static io.jsonapi4j.http.HttpStatusCodes.SC_406_NOT_ACCEPTABLE;
import static io.jsonapi4j.http.HttpStatusCodes.SC_415_UNSUPPORTED_MEDIA_TYPE;
import static io.jsonapi4j.http.HttpStatusCodes.SC_500_INTERNAL_SERVER_ERROR;
import static io.jsonapi4j.operation.OperationType.Method.GET;
import static io.jsonapi4j.operation.OperationType.READ_MULTIPLE_RESOURCES;
import static io.jsonapi4j.operation.OperationType.READ_TO_MANY_RELATIONSHIP;
