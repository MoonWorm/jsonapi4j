...
import io.jsonapi4j.domain.ToManyRelationship;
import io.jsonapi4j.domain.ToOneRelationship;
import io.jsonapi4j.domain.plugin.oas.RelationshipOasPlugin;
import io.jsonapi4j.domain.plugin.oas.ResourceOasPlugin;
...
import io.jsonapi4j.oas.customizer.util.OasSchemaNamesUtil;
import io.jsonapi4j.oas.customizer.util.SchemaGeneratorUtil.PrimaryAndNestedSchemas;
...
import static io.jsonapi4j.oas.customizer.util.OasSchemaNamesUtil.attributesSchemaName;
import static io.jsonapi4j.oas.customizer.util.OasSchemaNamesUtil.customResourceIdentifierMetaSchemaName;
import static io.jsonapi4j.oas.customizer.util.OasSchemaNamesUtil.customResourceIdentifierSchemaName;
import static io.jsonapi4j.oas.customizer.util.OasSchemaNamesUtil.customToManyRelationshipDocSchemaName;
import static io.jsonapi4j.oas.customizer.util.OasSchemaNamesUtil.customToOneRelationshipDocSchemaName;
import static io.jsonapi4j.oas.customizer.util.OasSchemaNamesUtil.errorsDocSchemaName;
import static io.jsonapi4j.oas.customizer.util.OasSchemaNamesUtil.multipleResourcesDocSchemaName;
import static io.jsonapi4j.oas.customizer.util.OasSchemaNamesUtil.relationshipsSchemaName;
import static io.jsonapi4j.oas.customizer.util.OasSchemaNamesUtil.resourceSchemaName;
import static io.jsonapi4j.oas.customizer.util.OasSchemaNamesUtil.singleResourceDocSchemaName;
import static io.jsonapi4j.oas.customizer.util.OasSchemaNamesUtil.toManyRelationshipsDocSchemaName;
import static io.jsonapi4j.oas.customizer.util.OasSchemaNamesUtil.toOneRelationshipDocSchemaName;
import static io.jsonapi4j.oas.customizer.util.SchemaGeneratorUtil.generateAllSchemasFromType;
import static io.jsonapi4j.oas.customizer.util.SchemaGeneratorUtil.generateSchemaFromType;
import static io.jsonapi4j.oas.customizer.util.SchemaGeneratorUtil.registerSchemaIfNotExists;
