...
@DirtiesContext
public class SpringAddUserCitizenshipsOperationTests extends AddUserCitizenshipsOperationTests {

    public SpringAddUserCitizenshipsOperationTests(@Value("${jsonapi4j.rootPath}") String jsonApiRootPath,
