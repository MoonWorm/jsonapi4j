...
public class SpringReadUserRelativesOperationTests extends ReadUserRelativesOperationTests {

    public SpringReadUserRelativesOperationTests(@Value("${jsonapi4j.root-path}") String jsonApiRootPath,
