...
@DirtiesContext
public class SpringDeleteUserCitizenshipsOperationTests extends DeleteUserCitizenshipsOperationTests {

    public SpringDeleteUserCitizenshipsOperationTests(@Value("${jsonapi4j.rootPath}") String jsonApiRootPath,
