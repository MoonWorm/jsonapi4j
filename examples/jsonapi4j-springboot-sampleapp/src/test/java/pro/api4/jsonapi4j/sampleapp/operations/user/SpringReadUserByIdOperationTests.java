...
public class SpringReadUserByIdOperationTests extends ReadUserByIdOperationTests {

    public SpringReadUserByIdOperationTests(@Value("${jsonapi4j.root-path}") String jsonApiRootPath,
