...
@DirtiesContext
public class SpringUpdateUserCitizenshipsOperationTests extends UpdateUserCitizenshipsOperationTests {

    public SpringUpdateUserCitizenshipsOperationTests(@Value("${jsonapi4j.rootPath}") String jsonApiRootPath,
