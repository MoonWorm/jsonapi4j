...
public class SpringReadMultipleUsersOperationTests extends ReadMultipleUsersOperationTests {

    public SpringReadMultipleUsersOperationTests(@Value("${jsonapi4j.root-path}") String jsonApiRootPath,
