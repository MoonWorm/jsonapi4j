...
import pro.api4.jsonapi4j.sampleapp.testsuite.user.ReadUserByIdOperationTests;

@QuarkusTest
@TestProfile(IntegrationTestProfile.class)
public class QuarkusReadUserByIdOperationTests extends ReadUserByIdOperationTests {

    public QuarkusReadUserByIdOperationTests(@ConfigProperty(name = "jsonapi4j.rootPath") String jsonApiRootPath,
