...
public class QuarkusAddUserCitizenshipsOperationTests extends AddUserCitizenshipsOperationTests {

    public QuarkusAddUserCitizenshipsOperationTests(@ConfigProperty(name = "jsonapi4j.rootPath") String jsonApiRootPath,
