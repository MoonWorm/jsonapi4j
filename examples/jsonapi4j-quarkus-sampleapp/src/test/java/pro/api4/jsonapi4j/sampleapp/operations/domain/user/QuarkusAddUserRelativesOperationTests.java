...
public class QuarkusAddUserRelativesOperationTests extends AddUserRelativesOperationTests {

    public QuarkusAddUserRelativesOperationTests(@ConfigProperty(name = "jsonapi4j.rootPath") String jsonApiRootPath,
