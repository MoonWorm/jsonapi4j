...
import pro.api4.jsonapi4j.sampleapp.testsuite.user.ReadMultipleUsersOperationTests;

@QuarkusTest
@TestProfile(IntegrationTestProfile.class)
public class QuarkusReadMultipleUsersOperationTests extends ReadMultipleUsersOperationTests {

    public QuarkusReadMultipleUsersOperationTests(@ConfigProperty(name = "jsonapi4j.rootPath") String jsonApiRootPath,
