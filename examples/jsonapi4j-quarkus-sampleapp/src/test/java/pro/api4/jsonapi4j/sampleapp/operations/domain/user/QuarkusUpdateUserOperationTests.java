...
public class QuarkusUpdateUserOperationTests extends UpdateUserOperationTests {

    public QuarkusUpdateUserOperationTests(@ConfigProperty(name = "jsonapi4j.rootPath") String jsonApiRootPath,
