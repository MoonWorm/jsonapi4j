...
public class QuarkusDeleteUserOperationTests extends DeleteUserOperationTests {

    public QuarkusDeleteUserOperationTests(@ConfigProperty(name = "jsonapi4j.rootPath") String jsonApiRootPath,
