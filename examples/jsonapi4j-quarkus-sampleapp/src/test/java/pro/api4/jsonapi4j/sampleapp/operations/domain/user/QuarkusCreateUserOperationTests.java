...
public class QuarkusCreateUserOperationTests extends CreateUserOperationTests {

    public QuarkusCreateUserOperationTests(@ConfigProperty(name = "jsonapi4j.rootPath") String jsonApiRootPath,
