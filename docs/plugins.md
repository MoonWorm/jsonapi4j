...
|--------|----------|-------------|
| [Access Control](/access-control-plugin/) | `jsonapi4j-ac-plugin` | Annotation-driven authorization with per-field anonymization based on authentication, entitlements, OAuth2 scopes, resource ownership, and custom policies |
