...
import io.jsonapi4j.servlet.JsonApi4jDispatcherServlet;
import io.jsonapi4j.servlet.request.body.RequestBodyCachingFilter;
import io.jsonapi4j.servlet.response.errorhandling.ErrorHandlerFactoriesRegistry;
import io.jsonapi4j.servlet.response.errorhandling.JsonApi4jErrorHandlerFactoriesRegistry;
import io.jsonapi4j.servlet.response.errorhandling.impl.DefaultErrorHandlerFactory;
import io.jsonapi4j.servlet.response.errorhandling.impl.Jsr380ErrorHandlers;
import io.jsonapi4j.springboot.autoconfiguration.ac.SpringJsonApi4jAccessControlConfig;
import io.jsonapi4j.springboot.autoconfiguration.cd.SpringJsonApi4jCompoundDocsConfig;
import io.jsonapi4j.springboot.autoconfiguration.oas.SpringJsonApi4jOasConfig;
...
public class SpringJsonApi4jAutoConfigurer {
    ...
    public JsonApi4j jsonApi4j(
        ...
        JsonApi4j jsonApi4j = new JsonApi4j(
                domainRegistry,
                operationsRegistry
        );
        jsonApi4j.setAccessControlEvaluator(accessControlEvaluator);
        jsonApi4j.setExecutor(jsonApiExecutorService);
        return jsonApi4j;
    }
